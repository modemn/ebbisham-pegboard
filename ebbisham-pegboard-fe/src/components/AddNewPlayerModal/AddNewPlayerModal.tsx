                                ...
                                {({ handleSubmit, handleChange, values, touched, errors }) => (
                                    <Form noValidate onSubmit={handleSubmit} id='addNewPlayerForm'>
                                        ...
                                        <FormGroup className='mb-3' controlId='validationFormik02'>
                                            ...
                                            <FormControl type='text' name='lastName' value={values.lastName} onChange={handleChange} isValid={touched.lastName && !errors.lastName} isInvalid={touched.lastName && !!errors.lastName} />
                                        ...
                                        <FormGroup className='mb-3' controlId='validationFormik03'>
                                            ...
                                            <FormControl as='select' name='gender' value={values.gender} onChange={handleChange} isValid={touched.gender && !errors.gender} isInvalid={touched.gender && !!errors.gender}>
